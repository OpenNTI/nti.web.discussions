	...
	test('Snapshot', () => {
		const bin = {
			...
			'Parent': {
				'forums': [
					{
						'NTIID': 'tag:nextthought.com,2011-10:unknown-OID-0x05513f:5573657273:ZkMpTMuJZj8',
						'MimeType': 'application/vnd.nextthought.forums.communityforum',
						'TopicCount': 2,
						'title': 'Parent One',
						edit: () => { },
						hasLink: () => true,
						getID: () => 'tag:nextthought.com,2011-10:unknown-OID-0x05513f:5573657273:ZkMpTMuJZj8',
						Links: []
					},
					{
						'NTIID': 'tag:nextthought.com,2011-10:unknown-OID-0x055199:5573657273:ZkMpTMuJZhn',
						'MimeType': 'application/vnd.nextthought.forums.communityforum',
						'TopicCount': 0,
						'title': 'Parent Two',
						edit: () => { },
						hasLink: () => true,
						getID: () => 'tag:nextthought.com,2011-10:unknown-OID-0x055199:5573657273:ZkMpTMuJZhn',
						Links: []
					}
				]
			}
